...
def gen_plane_images(image_folder, landmarks, image_type, output_contrast_range,
    ...
    # Liste des fichiers dans le dossier image_folder
    image_name_list = [fichier for fichier in os.listdir(image_folder) if fichier.endswith('.nii.gz')]
    ...
    for landmark_idx, landmark_name in enumerate(landmarks.keys()):
      ...
      src_landmark_coord_world = landmarks[image_basename][landmark_name]
...
def main():
    ...
    image_folder = r"C:\Users\MarwaABDERRAHIM\OneDrive - ABYS MEDICAL\Bureau\data_test\data_v2\case_1_org"
    landmarks_csv = r"C:\Users\MarwaABDERRAHIM\OneDrive - ABYS MEDICAL\Bureau\data_test\landmark_v2\case_1_org.csv"
    output_contrast_range = (0, 255)  # Set your desired contrast range
    output_image_spacing = (1.0, 1.0, 1.0)  # Set your desired output image spacing
    output_folder = r"C:\Users\MarwaABDERRAHIM\OneDrive - ABYS MEDICAL\Bureau\data_test\out"
    # Load landmarks from CSV file
    landmarks = load_coordinates_from_csv(landmarks_csv)

    # Generate plane images
    gen_plane_images(image_folder, landmarks, 'output_image_type', output_contrast_range,
                     output_image_spacing, output_folder)
